...
#requires ortools==9.3.10497
#!python3 -m pip install ortools==9.3.10497
...
class FairFlow(object):
    ...
    def __init__(self, loads, loads_lb, coverages, affs, sol=None):
        ...
        print("self.n_pap ",self.n_rev,self.n_pap)
        self.loads = loads
    ...
    def objective_val(self):
        ...
        return np.sum(self.sol_as_mat() * self.orig_affs) , self.orig_affs , self.sol_as_mat()
